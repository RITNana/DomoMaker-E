...
const AboutWindow = (props) => {
    return(
        ...
        className="mainForm"
        >
            <h1>DomoMaker! The Maker of Domos!</h1>
            <p> Here you're able to create multiple Domos, assign their ages, and their levels! </p>
            <p> Get them ready for battle! (or just get them ready for a normal life...)</p>
        </form>
